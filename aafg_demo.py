...
if __name__ == "__main__":
    ...
    gen = DataLoader(train_dataset, shuffle=shuffle, batch_size=batch_size, num_workers=num_workers, pin_memory=True,
                     drop_last=True, collate_fn=newyolo_dataset_collate, sampler=train_sampler)
    ...
    for iteration, batch in enumerate(gen):
        ...
        metas, filenames, images, targets, pil_bound_maxs, pil_bound_mins = batch[0], batch[1], batch[2], batch[3], batch[4], batch[5]
        adv_images = aafg(images, targets, metas, pil_bound_maxs, pil_bound_mins)
        # adv_images = tog(images, targets, metas)
