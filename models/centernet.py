...
from centernet_utils.utils import (cvtColor, get_classes, preprocess_input, resize_image,
                         show_config, newresize_image)
from centernet_utils.utils_bbox import decode_bbox, postprocess
...
class CenterNet(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : 'newlogs/best_epoch_weights.pth',
